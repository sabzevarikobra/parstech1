...
function defineCustomElement(options, extraOptions, _createApp) {
  ...
  if (isPlainObject2(Comp))
    extend2(Comp, extraOptions);
...
function walk(node, parent, context, doNotHoistNode = false, inFor = false) {
  ...
  if (slotCacheKeys.length && node.type === 1 && node.tagType === 1 && node.codegenNode && node.codegenNode.type === 13 && node.codegenNode.children && !isArray3(node.codegenNode.children) && node.codegenNode.children.type === 15) {
...
var parserOptions = {
  ...
  isNativeTag: (tag) => isHTMLTag3(tag) || isSVGTag3(tag) || isMathMLTag3(tag),
...
var isEventOptionModifier = makeMap3(`passive,once,capture`);
var isNonKeyModifier = makeMap3(
  // event propagation management
  `stop,prevent,self,ctrl,shift,alt,meta,exact,middle`
);
var maybeKeyModifier = makeMap3("left,right");
var isKeyboardEvent = makeMap3(`onkeyup,onkeydown,onkeypress`);
...
vue/dist/vue.esm-bundler.js:
  ...
  **)
*/
//# sourceMappingURL=chunk-NGXQORAB.js.map
